...
public class ExcelMergedRegionUtil {
    ...
    private static ExcelMergedRegionUtil instance = null;

    /**
     * 单例模式获取实例
     * @return ExcelUtil对象
     */
    public static ExcelMergedRegionUtil getInstance(){
        if (instance == null)
            instance = new ExcelMergedRegionUtil();
        return instance;
    }
    ...
    public String getCellValue(Cell cell){
        ...
        if(cell.getCellType() == Cell.CELL_TYPE_STRING){
            ...
            return emoveSpecialChar(cell.getStringCellValue());

        }else if(cell.getCellType() == Cell.CELL_TYPE_BOOLEAN){

            return emoveSpecialChar(String.valueOf(cell.getBooleanCellValue()));

        }else if(cell.getCellType() == Cell.CELL_TYPE_FORMULA){

            return emoveSpecialChar(cell.getCellFormula()) ;

        }else if(cell.getCellType() == Cell.CELL_TYPE_NUMERIC){

            return emoveSpecialChar(String.valueOf(cell.getNumericCellValue()));
     ...
     */
    public  String emoveSpecialChar(String value){
